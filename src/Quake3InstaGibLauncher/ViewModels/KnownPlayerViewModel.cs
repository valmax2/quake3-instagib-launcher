...
/// valutazione/note scrive subito nel modello condiviso e salva subito su disco (stessa lezione
/// imparata con Personalizza interfaccia: niente stato "non salvato" possibile).
/// </summary>
